               ...
               <div class="col-12">
                  <div class="card">
                     <div class="card-header">
                        <a href="<?= base_url('products/create') ?>" class="btn btn-sm btn-success pull-left">ADD NEW</a>
                        <a href="<?= base_url('products/inactive') ?>" class="btn btn-sm btn-danger pull-right">VIEW INACTIVE</a>
                     </div>
                     <!-- /.card-header -->
                     <div class="card-body">
                              ...
                              if (!empty($data)) {
                                 foreach ($data as $d) { ?>
                                    <tr>
                                       ...
                                       <td><?= $d->tech_talk; ?></td>
                                       <td>
                                          <a href="<?php echo base_url('products/edit/') . $d->id; ?>" class="btn btn-sm btn-success">Edit</a>
                                          <a href="<?php echo base_url('products/delete/') . $d->id; ?>" class="btn btn-sm btn-danger">Delete</a>
                                       </td>
                                    </tr>
                              <?php
                                 }
